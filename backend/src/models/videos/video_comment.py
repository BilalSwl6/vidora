...
class VideoComment(Base):
    """Represents a comment on a video by a user."""
    ...
    # Relationships
    user: Mapped["User"] = relationship("User", back_populates="video_comments")
    video: Mapped["Video"] = relationship("Video", back_populates="video_comments")
